namespace crgolden.Sage
{
        ...
        where T : SalesOrderDetail
    {
        ...
        {
            salesOrderDetail.HasIndex(e => new { e.SalesOrderNo, e.LineKey });
            salesOrderDetail.Property(e => e.SalesOrderNo).HasMaxLength(7);
            salesOrderDetail.Property(e => e.LineKey).HasMaxLength(6);
            salesOrderDetail.Property(e => e.LineSeqNo).HasMaxLength(14);
