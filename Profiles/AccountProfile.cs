    ...
    public class AccountProfile : Profile
    {
        public AccountProfile()
        {
            CreateMap<string[], Account>()
                ...
                .ForMember(dest => dest.Status, opt => opt.MapFrom(src => char.Parse(src[13])))
                .ForMember(dest => dest.ClearBalance, opt => opt.MapFrom(src => char.Parse(src[14])))
                .ForMember(dest => dest.AccountType, opt => opt.MapFrom(src => src[15]))
                .ForMember(dest => dest.CashFlowsType, opt => opt.MapFrom(src => char.Parse(src[16])))
                ...
                .ForMember(dest => dest.AccountCategory, opt => opt.MapFrom(src => char.Parse(src[22])))
