    ...
    public class SalesOrderDetailProfile : Profile
    {
        public SalesOrderDetailProfile()
        {
            CreateMap<string[], SalesOrderDetail>()
                ...
                .ForMember(dest => dest.PriceLevel, opt => opt.MapFrom(src => src[12]))
                ...
                .ForMember(dest => dest.PrintDropShipment, opt => opt.MapFrom(src => src[17]))
                ...
                .ForMember(dest => dest.StandardKitBill, opt => opt.MapFrom(src => src[23]))
                ...
                .ForMember(dest => dest.SkipPrintCompLine, opt => opt.MapFrom(src => src[35]))
