namespace crgolden.Sage100.PurchaseOrderHeaders
{
    ...
    public abstract class PurchaseOrderHeaderListRequestHandler<TRequest, THeader, TLine> : ListRequestHandler<TRequest, THeader>
        where TRequest : PurchaseOrderHeaderListRequest<THeader, TLine>
        ...
        where TLine : PurchaseOrderDetail
    {
        ...
        protected PurchaseOrderHeaderListRequestHandler(IEnumerable<IIntegrationService> integrationServices) : base(integrationServices)
        {
        }
