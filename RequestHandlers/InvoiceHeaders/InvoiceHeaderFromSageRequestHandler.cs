namespace crgolden.Sage.InvoiceHeaders
{
    ...
    public abstract class InvoiceHeaderFromSageRequestHandler<TRequest, THeader, TLine> : RecordFromSageRequestHandler<TRequest, THeader>
        where TRequest : InvoiceHeaderFromSageRequest<THeader, TLine>
        ...
        where TLine : InvoiceDetail
    {
        ...
        protected InvoiceHeaderFromSageRequestHandler(
            IMapper mapper,
            DbContext context,
            ILogger logger,
